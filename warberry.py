...
''') + bcolors.ENDC
    ...
    parser.add_option("-I", "--interface", action="store", dest="iface", default="eth0",help="Network Interface to use." + bcolors.WARNING + " Default: eth0" + bcolors.ENDC, choices=['net0','eth0', 'eth1', 'wlan0', 'wlan1', 'wlan2', 'at0'])
